  ...
  <Sh>
    <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ textAlign: "center", maxWidth: 360, width: "100%" }}>
        ...
        <p style={{ fontSize: 13, fontWeight: 300 }}>thank you for your application.</p>
        <div style={{ height: 10 }} />
        <p style={{ fontSize: 11, fontWeight: 200, color: "#999", lineHeight: 1.8 }}>
        ...
        >
          ...
          <span style={{ fontFamily: sans, fontSize: 11, fontWeight: 300, color: "#1a1a1a", letterSpacing: 1.5, borderBottom: "1px solid #1a1a1a", paddingBottom: 3 }}>spread the word →</span>
        </a>
        <div style={{ height: 64 }} />
        <button
          className="m-link"
          onClick={() => { setDone(false); goTo("listing"); }}
          style={{ background: "none", border: "none", fontFamily: sans, fontSize: 10, fontWeight: 300, color: "#bbb", cursor: "pointer", letterSpacing: 1.5, borderBottom: "1px solid #e0e0e0", paddingBottom: 2 }}
